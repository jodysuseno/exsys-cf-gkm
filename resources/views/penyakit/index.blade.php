    ...
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-body">
          ...
          <a href="{{ route('penyakit.create') }}" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah {{ $title }}</a>
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {{-- tombol edit --}}
                    <a href="{{ route('penyakit.edit', $item->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Edit</a>
                    {{-- tombol hapus --}}
                      ...
                      <div class="modal-dialog modal-sm modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <form class="d-inline" action="{{ route('penyakit.destroy', $item->id) }}" method="post">
                              @csrf
                              @method('delete')
