...
<main class="app-content">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="tile">
        <form action="{{ route('kompleksitas.update', $get_kompleksitas->id) }}" method="POST">
          @csrf
          @method('patch')
          ...
          <div class="tile-body">
            <div class="form-group">
              ...
              <input class="form-control @error('nama') is-invalid @enderror" type="text" name="nama" required value="{{ old('nama', $get_kompleksitas->nama) }}">
              @error('nama') <div class="form-control-feedback text-danger">{{ $message }}</div> @enderror
            </div>
            <div class="form-group">
              <label class="control-label">Bobot</label>
              <input class="form-control @error('bobot') is-invalid @enderror" type="number" name="bobot" required value="{{ old('bobot', $get_kompleksitas->bobot) }}">
